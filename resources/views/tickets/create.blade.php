                    ...
                    <form action="{{ route('tickets.store') }}" method="POST">
                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-800/10 pb-12">
                                ...
                                <p class="mt-1 text-sm/6 text-gray-500">These information will be shared with our agents to provide your further solutions.</p>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <p class="mt-3 text-sm/6 text-gray-400">Write a few sentences about your issue.</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-10 space-y-10">
                                    <fieldset>
                                        ...
                                        <p class="mt-1 text-sm/6 text-gray-400">Resolution time depends on the assigned priority.</p>
